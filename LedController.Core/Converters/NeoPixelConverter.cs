...
namespace LedController.Core.Converters
{

    public static class NeoPixelConverter
    {
        ...
        public static ReadOnlySpan<byte> Convert(ReadOnlySpan<Color> colors)
        {
